...
public static class Clients
{
    ...
    /// <summary>
    /// Create a service client for the app service.
    /// </summary>
    /// <param name="options">Options for the client, including endpoint and authorization method.</param>
    /// <returns>The <see cref="App.V2beta.AppService.AppServiceClient"/>.</returns>
    public static AppService.AppServiceClient AppService(Options options) =>
